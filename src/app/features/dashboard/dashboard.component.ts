  ...
  template: `
    <div class="space-y-6">
      ...
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Welcome back! Here's your business overview.</p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
          ...
          <p class="text-3xl font-bold text-gray-900">{{ totalOutstanding() | currency:'INR':'symbol':'1.0-0' }}</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
          ...
          <p class="text-3xl font-bold text-gray-900">{{ monthlySales() | currency:'INR':'symbol':'1.0-0' }}</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
          ...
          <p class="text-3xl font-bold text-gray-900">{{ monthlyExpenses() | currency:'INR':'symbol':'1.0-0' }}</p>
          <p class="text-xs text-gray-400 mt-1">This month</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
          ...
          <p class="text-3xl font-bold" [class]="profitLoss() >= 0 ? 'text-emerald-600' : 'text-red-500'">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <h3 class="text-base font-semibold text-gray-800 mb-4">Monthly Sales Trend</h3>
          <div class="h-48 bg-gray-50 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-200">
            <div class="text-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                   stroke="currentColor" class="w-10 h-10 text-gray-300 mx-auto mb-2">
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
              </svg>
              <p class="text-sm text-gray-400">Chart area — integrate Chart.js or similar</p>
            </div>
          </div>
        </div>

        <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <h3 class="text-base font-semibold text-gray-800 mb-4">Expense Breakdown</h3>
          <div class="h-48 bg-gray-50 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-200">
            <div class="text-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                   stroke="currentColor" class="w-10 h-10 text-gray-300 mx-auto mb-2">
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <div class="flex flex-wrap gap-3">
          <a routerLink="/customers" class="flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700
          ...
          <a routerLink="/transactions" class="flex items-center gap-2 px-4 py-2 bg-green-50 text-green-700
          ...
          <a routerLink="/payments" class="flex items-center gap-2 px-4 py-2 bg-purple-50 text-purple-700
          ...
          <a routerLink="/invoices" class="flex items-center gap-2 px-4 py-2 bg-orange-50 text-orange-700
          ...
          <a routerLink="/reports" class="flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-700
